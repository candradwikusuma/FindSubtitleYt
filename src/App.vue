  ...
  <div class="contain">
    <div class="d grid grid-cols-3">
      <div class="a lg:col-span-1 col-span-3">
        ...
        <div class="px-12 mt-8 md:px-24 md:mt-0 lg:px-12 lg:mt-12">
          <label
        ...
        <div class="px-12 md:px-24 lg:px-12">
          <label
            class="block uppercase tracking-wide text-thirdly text-xs font-bold mb-2"
            for="grid-first-name"
          >Search</label>
      ...
      <div class="b lg:col-span-2 col-span-3 relative">
		...
		c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"
          ...
          <button
            class="bg-primary text-white font-bold py-2 px-4 rounded terakhir"
            @click="navigasi('last')"
